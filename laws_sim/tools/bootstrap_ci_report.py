...
def main():
    ...
    print("=" * 70)
    print(f"F1:               intervalli {'SOVRAPPOSTI -> differenza NON dimostrata significativa' if f1_overlap else 'DISGIUNTI -> differenza statisticamente significativa'}")
    print(f"sqrt(sens*spec):  intervalli {'SOVRAPPOSTI -> differenza NON dimostrata significativa' if gm_overlap else 'DISGIUNTI -> differenza statisticamente significativa'}")
    ...
    report = {
        ...
        "significativo_95": {"f1": not f1_overlap, "geometric_mean": not gm_overlap},
    }
