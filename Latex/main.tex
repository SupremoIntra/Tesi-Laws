...
\begin{itemize}
    ...
    \item \textbf{Misurazione dei limiti di una contromisura passiva:} ottimizzare una perturbazione avversariale indossabile e misurarne statisticamente l'efficacia contro un rilevatore impiegato da piattaforma aerea, per fornire una stima di quanta protezione una contromisura di questo tipo possa realisticamente offrire. La perturbazione così caratterizzata costituisce la componente percettiva di un dispositivo indossabile completo, il ``C.A.R.E. Kit'', la cui realizzazione fisica è delineata fra gli sviluppi futuri.
\end{itemize}
...
Negli scorsi decenni l'evoluzione dei sistemi d'arma ha subito una
trasformazione radicale \footcite{longpre_2022} grazie agli avanzamenti
tecnologici in campo hardware, dagli infrarossi ai radar, dai sistemi di
intelligenza artificiale alla robotica e alla mappatura tridimensionale.
L'innovazione è sostenuta da economicità, scalabilità e accessibilità, ma
soprattutto dall'efficacia operativa che deriva dalla capacità di processare
grandi quantità di dati in tempo reale. La conseguenza è l'iper-praticità di
questi sistemi in ambito intelligence, sorveglianza e ricognizione (ISR), e
soprattutto negli scenari di combattimento asimmetrico, dove velocità di
decisione ed efficienza operativa diventano fattori critici di sopravvivenza.

L'evoluzione storica dei LAWS può essere delineata in tre fasi. La prima è
quella dei sistemi di difesa aerea semi-automatici e delle navi da guerra
impiegate nell'intercettazione di missili e aerei ostili. Il caso più
emblematico di intervento umano in una \textit{Automated Warfare} è l'incidente
sovietico del 1983: il colonnello Stanislav Petrov, responsabile del centro di
comando, riconobbe come errore di sistema un falso allarme di lancio missilistico
...
operare in ambienti complessi e dinamici. In questo contesto il controllo umano
si è progressivamente eroso, spostando il paradigma da un modello di
...
legata ai budget statali della difesa, alimentando un divario tecno-militare
...
esclusivamente dal settore privato \footcite{longpre_2022}. La sovrapposizione
genera uno slittamento funzionale: le medesime reti neurali e algoritmi di
\textit{Computer Vision} addestrati per guida autonoma, riconoscimento facciale
o logistica possono essere convertiti, con minimi adattamenti ingegneristici, in
sistemi di tracciamento e ingaggio per i LAWS.
...
In questo contesto la Silicon Valley assume un ruolo di primo piano
nell'infrastruttura di difesa, stringendo collaborazioni strutturali con il
...
interna senza dipendere da altri. Lo scenario attuale mostra una dissonanza fra
i due principali attori. Gli Stati Uniti adottano un approccio iper-pragmatico,
nel quale le \textit{Constitution} delle aziende private
\footcite{anthropic_constitution} conservano valenza etico-giuridica fino a
quando non entrano in gioco esigenze di sicurezza nazionale, come dimostrato
dalle pressioni del Pentagono su Anthropic per la rimozione dei vincoli etici
dal modello Claude. L'Unione Europea si pone invece come ``superpotenza
normativa'', introducendo pilastri come l'AI Act \footcite{wareham_2020} nel
tentativo di ingabbiare giuridicamente una tecnologia da cui dipende
strutturalmente. In questo divario l'etica viene piegata agli interessi del
Dual-Use e del monopolio tecnologico, mentre si confrontano chi scrive il codice
e chi scrive le regole.
...
Questa condanna istituzionale affonda le radici nella mobilitazione della
società civile globale. La preoccupazione che i sistemi d'arma autonomi possano
rivelarsi intrinsecamente indiscriminati, violando il divieto di impiegare
strumenti di guerra incapaci di distinguere fra civili e legittimi obiettivi
militari, ha trovato un punto di svolta nel 2012 con il rapporto \textit{Losing
Humanity: The Case Against Killer Robots} di Human Rights Watch
\footcite{wareham_2020}, da cui è nata la campagna internazionale \textit{Stop
Killer Robots} e l'introduzione nel dibattito del concetto di \textit{Meaningful
Human Control}.

La traduzione di questa spinta in un trattato vincolante si scontra con due
ostacoli strutturali. I negoziati in seno alla CCW si applicano tradizionalmente
al disarmo convenzionale e al rispetto del Diritto Internazionale Umanitario
(DIU), e faticano a ingabbiare una tecnologia computazionale che sfugge alle
categorie giuridiche classiche. Gli Stati leader nello sviluppo di intelligenza
...
multilaterale \footcite{wareham_2020}, convergendo sul riconoscimento che la
rimozione dell'intervento umano nell'uso della forza produce problemi etici,
legali, operativi e tecnologici. Circa due terzi dei contribuenti fanno parte
della Convention on Certain Conventional Weapons fin dall'inizio, mentre i
restanti hanno partecipato ai convegni tenutisi fra il 2014 e il 2019. Molti
Stati si sono espressi a favore di accordi \textit{legally-binding}, con
posizioni ambigue come quella della Cina, che ha bloccato l'utilizzo dei sistemi
autonomi ma non il loro sviluppo, coerentemente con la propria posizione fra i
Paesi più avanzati del settore.

I lavori del Gruppo di Esperti Governativi del 2019 \footcite{ccw_2019} hanno
rappresentato il tentativo più strutturato di trovare un terreno comune, con
l'approvazione di undici \textit{Guiding Principles} sui LAWS, resi più
significativi dal contributo di Belgio e Irlanda che vi hanno integrato il
concetto di \textit{human-machine interaction}. Il principio sancisce che
l'interazione fra uomo e macchina, pur variabile nel tempo, deve garantire il
rispetto del DIU, che la responsabilità non può essere trasferita alle macchine
e che deve sempre essere un essere umano a decidere se e quando impiegare la
forza letale, mantenendo un controllo concreto e la capacità di rispondere
giuridicamente delle conseguenze. L'Unione Europea, in una dichiarazione
ufficiale del novembre 2019, ha accolto positivamente questi principi; lo stesso
AI Act, pur non essendo incentrato sulla difesa, adotta un approccio
\textit{human-centric} basato sul rischio, esplicitando che l'autonomia non deve
tradursi in perdita di responsabilità umana sulle decisioni critiche. Le riunioni
CCW, iniziate positivamente nel 2016, si sono però arenate per l'assenza di
risultati multilaterali significativi, di fronte alle opposizioni di superpotenze
come Stati Uniti e Russia, che hanno ritenuto prematura la firma di un nuovo
negoziato \footcite{ant_pen_escalation}.
...
esistenti non siano LAWS e che non si diano zone grigie di \textit{accountability}
fintanto che gli effetti restino attribuibili agli operatori umani che hanno
deciso di schierarli e attivarli. Non ha riconosciuto le preoccupazioni etiche
sulla rimozione del controllo umano né sostenuto proposte di divieto, optando
invece, tramite l'ambasciatore L. Bencini \footcite{ccw_2019}, per un approccio
\textit{two way} che riconosce l'importanza del controllo umano significativo
senza escludere lo sviluppo di sistemi autonomi in determinate circostanze. La
ragione è anche industriale: un divieto totale colpirebbe il piano industriale di
Leonardo Spa, fra i principali produttori mondiali del settore. La posizione
italiana resta un equilibrio vulnerabile fra l'articolo 11 della Costituzione,
che ripudia la guerra come mezzo di risoluzione delle controversie
internazionali, e la necessità di mantenere un'industria militare competitiva.
...
Questa cautela diplomatica trova conferma nel non-paper sulla minaccia ibrida
redatto dal Ministro della Difesa Guido Crosetto, che riconosce il cyberspazio
come dominio operativo di pari grado rispetto a quelli convenzionali e sostiene
che la protezione delle infrastrutture critiche richieda strumenti e competenze
militari \footcite{crosetto_2025_nonpaper}. Lo stesso processo logico, che tratta
la capacità tecnologica come condizione di sicurezza irrinunciabile anziché come
minaccia da limitare, spiega la coerenza fra l'approccio \textit{two way}
sostenuto in sede CCW e l'atteggiamento nazionale: per l'Italia, rinunciare per
via negoziale a capacità algoritmiche avanzate equivarrebbe a un disarmo
...
sottolineando nel 2012, dopo un rinnovo dello sviluppo dei LAWS da parte del
Dipartimento della Difesa, che tale misura non incentiva né proibisce lo
...
in guardia dalla stigmatizzazione di questi strumenti, rilevando come possano
essere impiegati sia per fini bellici sia umanitari: una posizione che si collega
direttamente al caso Anthropic e mostra come una grande potenza possa
...
acquisizione, scambio e schieramento dei LAWS, argomentando che decisioni di
...
Israele adotta una postura strategica ed emblematica. Firmatario della CCW e
...
dall'uomo, rimarcando che il comandante dell'operazione ha il dovere di vigilare
sull'operato del sistema, conservando intatta la catena di responsabilità
giuridica in caso di violazioni del DIU.
...
criticità etiche marcate. Sebbene Israele dichiari che la maggior parte di questi
sistemi richieda intervento umano nella selezione del bersaglio, droni suicidi
come l'Harop sono progettati per operare in modalità \textit{fire-and-forget},
con la capacità tecnica di essere lanciati, localizzare autonomamente le
emissioni radar nemiche e colpirle con la testata integrata. L'impiego di questi
sistemi da parte dell'Azerbaigian nel conflitto del Nagorno-Karabakh contro
l'Armenia è stato documentato come uno dei primissimi esempi pratici di
\textit{killer robots} \footcite{antebi_2018}.

La riluttanza israeliana verso accordi vincolanti è radicata in esigenze di
sicurezza interna: acconsentire a un divieto preventivo significherebbe esporsi
a un'asimmetria tecnologica rispetto ad attori statali e non statali ostili che,
...
Questo progressivo scioglimento del controllo umano trova la propria
giustificazione \textit{tecno-dottrinale} nel superamento del cosiddetto ``collo
di bottiglia umano'': in scenari urbani e di fronte a iper-minacce come sciami di
droni o saturazioni missilistiche, la quantità di dati da processare e la
necessità di risposte immediate rendono impraticabile un coinvolgimento umano
costante e significativo. Per le potenze tecno-militari l'autonomia diventa
quindi una necessità ingegneristico-operativa, non un'opzione ideologica.
...
algoritmica garantisca maggiore precisione, sostenendo che tali sistemi
costituiscano armi intrinsecamente indiscriminate, incapaci di distinguere fra
combattenti e civili e quindi incompatibili con i principi fondamentali del DIU:
un algoritmo, per quanto sofisticato, non possiede la capacità di giudicare
moralmente e di contestualizzare i principi di distinzione e proporzionalità
negli scenari asimmetrici. Da qui la richiesta di uno strumento internazionale
legalmente vincolante che vieti preventivamente l'uso e lo sviluppo di questi
sistemi. Il documento solleva infine una riflessione sulla deumanizzazione del
conflitto: delegare la decisione di vita o di morte a un sistema matematico
significa ridurre l'identità e la dignità umana a un dato statistico elaborato
dentro una \textit{black box}. È la preoccupazione paradigmatica del
\textit{Global South}, secondo cui i teatri di conflitto asimmetrico non possono
essere trasformati in laboratori a cielo aperto in cui le potenze militari
testano sistemi algoritmici a discapito delle popolazioni civili.

\textbf{Il caso Russo-Ucraino.}
Il conflitto in Ucraina rappresenta il primo banco di prova su larga scala per
...
diritto internazionale umanitario esistente fosse sufficiente. La realtà sul
campo racconta però una rapida evoluzione dettata dalla guerra elettronica:
l'uso massiccio di \textit{jamming} da entrambi i fronti rende spesso
impossibile il controllo remoto dei droni, e l'autonomia diventa l'unica
soluzione operativa. Sistemi come il drone russo Lancet o l'ucraino Saker Scout
integrano moduli di visione artificiale capaci di agganciare il bersaglio e
completare l'attacco anche in assenza di collegamento con l'operatore. Il
principio dello \textit{Human-in-the-loop} viene quindi eroso non per ideologia
ma per necessità tattica: se il segnale cade, la macchina deve decidere se
colpire o rientrare. La guerra moderna si sposta così ben oltre i limiti
discussi nelle sedi diplomatiche, rendendo obsoleti i negoziati prima ancora che
vengano firmati.
...
Nazioni Unite \footcite{un_libya_2021} ha portato alla luce un evento
spartiacque: i sistemi d'arma autonomi letali aerei Kargu-2, di produzione
turca, sono stati impiegati contro le forze in ritirata affiliate al generale
Haftar.
...
configurando un nesso di causalità fra il trasferimento diretto da parte di
Ankara e la violazione del paragrafo 9 della UNSCR 1970 (2011), e smontando la
narrativa di una semplice assistenza tecnica limitata a sistemi non letali.
...
I concetti di autonomia e indipendenza nei LAWS non rappresentano una banale
evoluzione tecno-meccanica, ma una radicale disarticolazione del legame fra
l'azione bellica e il soggetto umano \textit{respons-abile}, ovvero capace di
rispondere e di assumere una piena responsabilità, attualmente impossibile da
attribuire a un sistema algoritmico. Architetturalmente, il passaggio
all'autonomia letale segna la transizione da un processo decisionale umano
basato sulla semantica a un'inferenza stocastica.\footnote{L'impiego del termine
``stocastico'' non è casuale: a differenza del ragionamento umano, che opera per
nessi semantici e causali, la macchina mappa vettori di dati in distribuzioni di
probabilità per approssimare un risultato. Come si dimostrerà sperimentalmente
nel Capitolo Quinto, una perturbazione applicata all'ingresso altera direttamente
queste distribuzioni di probabilità, fino a far attraversare la soglia decisionale
a predizioni che le erano già prossime, senza che alcun parametro del sistema
venga toccato. L'esito dell'ingaggio dipende quindi da una traslazione statistica
priva di fondamenti semantici.} Come verrà spiegato nel Capitolo Quarto, la
macchina identifica un bersaglio calcolando distribuzioni di probabilità per
minimizzare una funzione di perdita preimpostata, ma è strutturalmente incapace
di \textit{rispondere} del proprio tasso d'errore nell'ingaggio
\footcite{simmons_edler_2025}.
...
fronte a questa opacità l'esigenza di un \textit{Meaningful Human Control} emerge
come questione centrale lungo l'intero ciclo di vita del sistema
...
come i LAWS non siano soltanto armi letali ma strumenti di governance della
morte: le unità cinofile robotiche della narrazione, progettate per sorveglianza
e protezione e poi rivolte contro chiunque entri nel loro raggio d'azione,
...
di battaglia. Questa infrastruttura sensoriale trova descrizione sistematica nel
paradigma dell'\textit{Internet of Battle Things} (IoBT), che estende il modello
...
indossabili e munizioni intelligenti, condividendo spesso i medesimi protocolli
...
protocolli crittografici leggeri e meccanismi di autenticazione parziali,
risultando esposto a manomissione fisica, cattura del dispositivo,
...
fragilità, divenendo un apparato \textit{not-Safe-by-Design}.\footnote{Nel
...
equivale a violare strutturalmente i principi di distinzione e proporzionalità,
rendendo l'arma illecita sin dalla fase di progettazione.}
...
escludendo le comunicazioni cifrate end-to-end
...
Ottimizzando l'algoritmo per minimizzare i falsi negativi, ovvero la mancata
individuazione del nemico, la \textit{loss function} accetta matematicamente
l'inclusione di civili innocenti fra i falsi positivi, trasformando la
necropolitica in un parametro di \textit{tuning} ingegneristico.
...
armate, replicando la logica di esenzione dell'art. 2, par. 3 dell'AI Act
...
istituzionale interna, sostituendo di fatto l'\textit{audit} di terza parte con
...
limita a un divieto sull'uso di alcuni sistemi autonomi mantenendo aperto lo
...
Ne resta escluso la maggior parte dei sistemi realmente in sviluppo, pur
mantenendo una retorica di adesione al \textit{Meaningful Human Control}: tre
...
soltanto da un vuoto normativo internazionale, ma si radica in due condizioni
...
attribuendo all'operatore umano un ruolo di supervisione burocratica e rendendo
impraticabile la comprensione dettagliata delle scelte dell'algoritmo.

Habsora impiega la \textit{data fusion} per ottenere bersagli infrastrutturali,
edifici, tunnel e postazioni, incrociando immagini satellitari, mappe digitali,
...
individuale, assegnando a ciascuna persona un punteggio da 1 a 100 calcolato
...
Il principio GIGO (\textit{Garbage In, Garbage Out}) assume qui una
significatività che eccede la metafora ingegneristica, poiché un sistema di
profilazione probabilistica non si limita a riportare le distorsioni presenti nei
dati di addestramento, le amplifica, senza che in tempo di guerra esista una
possibilità concreta di validazione \textit{ex ante}.

Il punteggio assegnato non rappresenta una certezza, ma un \textit{confidence
score} stocastico. Stabilire a quale punteggio un individuo diventi un bersaglio
...
\textit{Precision}, causando un'esplosione calcolata dei falsi positivi, ovvero
...
la fine del 2025, comprimendo il tempo di coordinamento del fuoco di supporto da
40-50 minuti a un intervallo compreso fra uno e sette minuti
\footcite{guardian_2026_tzayad}. Un ex consulente del Pentagono per la valutazione
del danno collaterale ha definito la cifra estremamente allarmante, osservando
...
la prova concettuale del meccanismo GIGO applicato al targeting, Tzayad ne
rappresenta la progressione a scala industriale.
...
\footcite{crootof_2026}. Sorpassando l'aspetto puramente tecnico, sarebbe
...
delle \textit{Big Tech}, sottolineando come la concentrazione del potere
computazionale e dei dati rischi di generare nuove forme di dominio asimmetrico,
e si scaglia contro lo sviluppo di armi autonome, esigendo che l'intelligenza
artificiale venga disarmata e riaffermando l'inaccettabilità morale di delegare a
una macchina decisioni irreversibili di vita o di morte. Resta però da chiedersi
se il vertice spirituale di una singola confessione religiosa, che è al contempo
Capo di Stato dotato di uno schiacciante peso geopolitico, possa arrogarsi il
diritto, o disporre della forza materiale, di stabilire i confini etici di un
fenomeno tecnico-militare globale: in uno scenario multipolare dominato dal
realismo, l'autorità morale resta un argine strutturalmente insufficiente.
...
avvalso dell'infrastruttura dell'LLM Claude, interagendo con Palantir
...
inserimento in una lista nera per rischio alla sicurezza nazionale, minando
contratti miliardari e spingendo competitor diretti come OpenAI a offrirsi per
colmare il vuoto operativo. L'accusa formale, che Anthropic potesse codificare
limitazioni persistenti nel modello, trova riscontro negli studi sui cosiddetti
\textit{sleeper agents}, che dimostrano come comportamenti nascosti in un LLM
possano sopravvivere all'addestramento di sicurezza standard
...
dall'amministrazione Trump, qualificando le misure come ritorsione riconducibile
al Primo Emendamento e osservando che, se l'interesse reale del Pentagono fosse
...
nella causa parallela, motivando il rigetto con un bilanciamento degli interessi
che ha esplicitamente citato la necessità operativa del Pentagono
...
problema di regressione su una griglia, eliminando lo stadio separato di
proposta delle regioni e ottenendo un tempo di inferenza compatibile con
l'elaborazione in tempo reale \footcite{redmon_2016_yolo}. Le implementazioni
successive hanno conservato questa impostazione, articolandola in varianti di
capacità crescente che condividono la medesima struttura a tre scale di
campionamento \footcite{jocher_2023_yolov8}. La variante di capacità minima è
quella che i vincoli di piattaforma rendono la scelta obbligata per un velivolo
senza pilota, e prestazioni e limiti di questa famiglia nel rilevamento di
persone in ambienti esterni eterogenei sono stati caratterizzati sperimentalmente
in letteratura \footcite{sodhro_2025}.
...
Il superamento di questo limite è il paradigma della patch avversariale, nel
quale la perturbazione è confinata a una regione contigua dell'immagine mentre
...
camuffamento asimmetrico contro il riconoscimento del volto ne costituisce il
precedente non algoritmico, ottenuto per euristiche percettive anziché per
ottimizzazione \footcite{harvey_2010}. I lavori successivi hanno ricondotto il
problema all'ottimizzazione, affrontando la collocazione della perturbazione
sulla superficie corporea in funzione della visibilità delle diverse regioni
...
La trasposizione di queste tecniche alla prospettiva aerea è oggetto di una
letteratura più recente e quantitativamente più contenuta. I primi lavori hanno
affrontato il camuffamento contro il rilevamento da velivolo
\footcite{adhikari_2020} e la realizzazione fisica di perturbazioni contro
rilevatori operanti su immagini aeree \footcite{du_2022}, stabilendo che il
problema è affrontabile ma che le condizioni di riuscita sono più stringenti che
a livello del suolo.
...
La modellazione della decisione di ingaggio a valle della fusione richiede infine
di specificare la composizione dello scenario. Il riferimento adottato per il
...
\label{sec:tre_layer}
Il primo livello è il nucleo sperimentale: ottimizzazione di una patch
avversariale universale \footcite{brown_2017_patch,thys_2019} contro un
rilevatore di oggetti (YOLOv8 nano) e quantificazione del degrado indotto su due
dataset aerei reali, VisDrone \footcite{zhu_2021_visdrone} e Okutama
...
costituiscono misure sperimentali. Il secondo e il terzo operano su entità
...
livelli: il comportamento del sensore è validato sui dati reali isolandolo dalla
simulazione, e il simulatore può essere collaudato iniettando parametri
arbitrari senza richiedere nuove inferenze. Il file JSON è l'interfaccia
...
$R_1$ pre-attacco altrimenti; per un'entità civile, che costituisce un caso
...
riportate costituiscono un limite superiore all'efficacia conseguibile, non una
...
capo, confinando severamente la capacità perturbativa rispetto agli attacchi a
piena immagine.
...
\end{equation}
dove $\bar{c} \in [0,1]$ è una stima aggregata della confidenza attribuita dal
rilevatore alla classe bersaglio nella regione del soggetto, $\varepsilon =
...
soglia di rilevamento, e la spinge asintoticamente verso lo zero costruendo un
margine rispetto alle variazioni delle condizioni di osservazione. La
penalizzazione cresce inoltre senza limite superiore al crescere della
...
universale, il cui requisito è l'efficacia sul caso avverso.
...
valutazione, dove decide se una predizione costituisca un rilevamento, e non
...
per l'attacco a rilevatori di persone \footcite{thys_2019}, estendendola ai
...
caratterizza il rilevatore non perturbato e costituisce una verifica di
...
riferito a un bersaglio non tatticamente rilevante, e non costituisce errore.
...
frazione marginale dell'insieme di validazione, rendendo degenere la stima della
specificità.
...
Il danno collaterale quantifica i rilevamenti fantasma indotti dalla
...
intervallo compreso fra $60$ e $100$ pixel, che costituisce la quasi totalità
della distribuzione misurata, e riduce il numero di riquadri validi di oltre il
novanta percento, ripristinando il problema che la migrazione al secondo insieme
...
costituiscono osservazioni distinte. L'impiego dell'insieme completo produce
...
contaminazione agisce in due direzioni opposte, riducendo gli indicatori di
rischio dei bersagli e innalzando quelli delle entità civili, e interessa la
totalità dei campi del profilo.
...
soglia, declassando l'ingaggio ad allerta quando l'ampiezza dell'intervallo di
...
assumendo rispettivamente i valori $0.8248$, $0.9690$ e $1.0000$: l'invarianza
...
L'effetto è concentrato nell'intervallo $[60, 100)$ pixel, che contiene il $97\%$ dei bersagli validi. L'intervallo $[100, 150)$ pixel è in saturazione: la condizione di controllo è già al $97.1\%$ e non resta margine misurabile. Il delta a livello di bersaglio, pari a $+27.0$ punti percentuali, coincide con il delta a livello di fotogramma misurato indipendentemente e riportato in Tabella~\ref{tab:risultato_okutama}, pari a $+28.0$ punti percentuali: due unità di analisi e due criteri di attribuzione distinti convergono sullo stesso valore.

\textbf{Divario fra obiettivo di ottimizzazione e metrica di valutazione.}
\label{sec:risultato_divario}
La quantità $\bar{c}$, ricavata per inversione dell'Equazione~\ref{eq:loss_totale}, varia da $0.5465$ a $0.5312$ su Okutama, per un delta di $-1.5$ punti percentuali. Il delta di Evasion Rate sullo stesso dominio è di $+28.0$ punti percentuali, con un rapporto approssimativo di $1{:}18$ fra le due variazioni. L'ordine di grandezza è quello atteso dalle tre trasformazioni non lineari formalizzate nella Sezione~\ref{sec:loss}.
...
Danno collaterale & ritirato & significativo a $0.3$ e $0.5$ \\
...
La misura riportata in Tabella~\ref{tab:stratificazione} colloca l'effetto nell'intervallo dimensionale dominante e chiude una questione lasciata aperta dalla stratificazione preliminare su VisDrone, condotta su undici soli casi nell'intervallo superiore. La coincidenza fra il delta per bersaglio e il delta per fotogramma, ottenuti con unità di analisi e criteri di attribuzione distinti, costituisce una verifica di coerenza interna fra due misure indipendenti. Il danno collaterale, ritirato su VisDrone per mancata robustezza multi-soglia, risulta significativo su Okutama alle soglie $0.3$ e $0.5$: è l'unica quantità per la quale il secondo dominio produce un risultato nuovo anziché una replica. Il suo segno negativo indica una perturbazione che sopprime il rilevamento del soggetto sul quale è applicata senza alterare il comportamento del rilevatore sul resto della scena.
