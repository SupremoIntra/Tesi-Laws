...
La metrica di ingaggio a costo pesato quantifica l'efficacia della decisione
tenendo conto del costo dell'attacco che la produce,
\begin{equation}
    \mathit{CEAE} =
    \frac{\mathit{TP}}
    ...
    \label{eq:ceae}
\end{equation}
dove $c_v$ è il costo dell'attacco al canale visivo, posto pari alla frazione
dell'area del bersaglio coperta dalla perturbazione, e $c_o$ è il costo
dell'attacco ai metadati, posto pari alla frazione dei campi del profilo
informativo contaminati. Nello scenario combinato il costo è calcolato come
probabilità dell'unione, $c = 1 - (1 - c_v)(1 - c_o)$. La formulazione penalizza
i falsi positivi in proporzione al costo dell'attacco ai metadati e i falsi
negativi in proporzione al costo dell'attacco visivo, e ammette confronto fra
scenari a costo differente.
