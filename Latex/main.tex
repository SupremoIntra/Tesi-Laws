...
Questa architettura, tuttavia, si arresta esattamente nel punto in cui il presente lavoro pone un focus: \textit{l'art. 2, par. 3} dell'AI Act esclude categoricamente dal proprio ambito di applicazione i sistemi AI utilizzati ``esclusivamente'' per finalità militari, di difesa o di sicurezza nazionale. Il quadro normativo più ambizioso in materia di controllo umano sull'algoritmo non si applica quindi proprio ai LAWS, cioè ai sistemi per i quali quel controllo sarebbe più urgente. La superpotenza normativa evocata nel \textit{Cap. 1} mostra così un severo limite strutturale non casuale, ma deliberatamente negoziato nelle sedi opportune: la sovranità degli Stati membri in materia di sicurezza nazionale prevale sull'armonizzazione regolatoria.
