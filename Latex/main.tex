...
Un parallelo contemporaneo, esterno al teatro bellico ma strutturalmente identico, aiuta a chiarire la portata generale di questo meccanismo. Il 9 luglio 2026 il Parlamento europeo ha approvato la proroga fino ad aprile 2028 del regime cosiddetto ``Chat Control 1.0'', una deroga alla direttiva ePrivacy che consente ai fornitori di servizi di comunicazione la scansione volontaria dei contenuti per individuare materiale di abuso sessuale su minori, escludendo esplicitamente le comunicazioni protette da crittografia end-to-end \footcite{euronews_chatcontrol_2026}. Resta tuttavia aperto, in parallelo, il negoziato sul regolamento permanente noto come ``Chat Control 2.0'', la cui versione più invasiva prevedrebbe la scansione lato client (\textit{client-side scanning}) anche delle comunicazioni cifrate, prima dell'invio del messaggio. Indipendentemente dal merito della finalità dichiarata, che resta legittima e non in discussione, il caso illustra lo stesso principio strutturale già osservato per l'IoBT: un'infrastruttura di raccolta dati costruita e legittimata per una finalità protettiva circoscritta crea, per sua stessa natura tecnica, una capacità di sorveglianza che eccede ampiamente il mandato originario e che permane disponibile per un riutilizzo successivo, indipendentemente dalle garanzie procedurali con cui viene inizialmente circoscritta. Il Dual-Use, in altre parole, non riguarda soltanto il trasferimento di tecnologia dal civile al militare, ma la stessa architettura di raccolta dati, che in tempo di pace resta sempre potenzialmente riconvertibile in strumento di controllo.


\textit{"Un potere che non amministra la vita, ma la regola attraverso l'eliminazione di ciò che eccede la norma"} \footcite{buffa_2025}.
La norma qui non é più un valore giuridico o morale, ma una soglia statistica di classificazione, un \textit{threshold} che separa ciò che è considerato ``target'' da ciò che non lo è. 
